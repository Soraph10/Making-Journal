...
For the choices I decided to make for my data collection I feel as though I picked the easy route as this is something I'm comfortable with noting down and showing. Although I feel as though that I could've done a better job at doing the data visualisation part due to some drawings having the possibilty of being misunderstood as something else without the questions I used to represent them available. As for what is left out I suppose a better visualisation could've been done or rather if I had picked a detailed question to ask myself perhaps the results would have been better.

This exercise relates to data humanism and the Dear Data project as this manual process allows us to collect data on mundane topics or details with a key to represent it. In a way this helps yourself notice certain behaviours and patterns which can go quite deep the further you explore it. Showing not just us but to others the things we do in our life when we only see the raw data rather than just conversations between each other.


## Images & Media

![Questions](<../assets/week-01/images/Questions.jpg>)
![Questions Drawing](<../assets/week-01/images/Questions Drawing.jpg>)
![Another Group's Questions](<../assets/week-01/images/Another group's questions.jpg>)
![Another Group's Drawings](<../assets/week-01/images/Another group drawings.jpg>)
![Data Questions](<../assets/week-01/images/Data questions.jpg>)
![Data Visualisation](<../assets/week-01/images/Data Visualisation.jpg>)
